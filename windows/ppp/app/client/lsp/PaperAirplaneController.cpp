    ...
    namespace app
    {
        namespace client
        {
            namespace lsp
            {
                ...
                PaperAirplaneController::ContextPtr PaperAirplaneController::GetContext() noexcept
                {
                    return context_;
                }

                std::shared_ptr<PaperAirplaneController> PaperAirplaneController::GetReference() noexcept
                {
                    return shared_from_this();
                }

                std::shared_ptr<VEthernetExchanger> PaperAirplaneController::GetExchanger() noexcept
                {
                    return exchanger_;
                }

                PaperAirplaneController::AppConfigurationPtr PaperAirplaneController::GetConfiguration() noexcept
                {
                ...
                bool PaperAirplaneController::OpenControlBlockPort(int interface_index) noexcept
                {
                    ...
                    bool ok = block_port->Set(interface_index, localEP.port());
                    if (!ok)
                    {
                        return false;
                    }
                ...
                bool PaperAirplaneController::Open(int interface_index) noexcept
                {
                    if (disposed_)
                    {
                        return false;
                    ...
                    return OpenAllAcceptors() &&
                        OpenControlBlockPort(interface_index) &&
                ...
                PaperAirplaneController::PaperAirplaneConnectionPtr PaperAirplaneController::NewConnection(const std::shared_ptr<boost::asio::io_context>& context, const std::shared_ptr<boost::asio::ip::tcp::socket>& socket) noexcept
                {
                    auto self = shared_from_this();
                    return make_shared_object<PaperAirplaneConnection>(self, context, socket);
                }
                ...
                bool PaperAirplaneController::Timeout(int milliseconds, const Timer::TimeoutEventHandler& handler) noexcept
                {
                    ...
                    std::shared_ptr<Timer> timeout = Timer::Timeout(milliseconds, make_shared_object<Timer::TimeoutEventHandler>(std::bind(&TimeoutHandler::Call, h)));
                    if (NULL == timeout)
                    {
                        return false;
                    }
                ...
                bool PaperAirplaneController::AcceptMasterAcceptor() noexcept
                {
                    ...
                    return ppp::net::Socket::AcceptLoopbackAsync(acceptors_[0],
                        ppp::make_shared_object<ppp::net::Socket::AcceptLoopbackCallback>(
                ...
                {
                    auto self = shared_from_this();
                    return ppp::net::Socket::AcceptLoopbackAsync(acceptors_[1],
                        ppp::make_shared_object<ppp::net::Socket::AcceptLoopbackCallback>(
                            [self, this](const ppp::net::Socket::AsioContext& context, const ppp::net::Socket::AsioTcpSocket& socket) noexcept
                            {
                                if (disposed_)
                                {
                                    return false;
                                ...
                                return AcceptForwardClient(context, socket, remoteEP);
                            }));
                }

                bool PaperAirplaneController::AcceptForwardClient(const ppp::net::Socket::AsioContext& context, const ppp::net::Socket::AsioTcpSocket& socket, const boost::asio::ip::tcp::endpoint& remoteEP) noexcept
                {
                    ...
                    auto configuration = exchanger->GetConfiguration();
                    if (NULL == configuration)
                    {
                        return false;
                    }
                    ...
                    std::shared_ptr<PaperAirplaneConnection> connection = NewConnection(context, socket);
                    if (NULL == connection)
                    {
                        connection->Dispose();
                        return false;
                    ...
                    bool bok = ppp::coroutines::YieldContext::Spawn(allocator.get(), *context,
                        [self, this, connection, remoteEP](ppp::coroutines::YieldContext& y) noexcept
                        {
                            bool bok = false;
                            if (!disposed_)
                            {
                ...
                bool PaperAirplaneController::Reset() noexcept
                {
                    ...
                    return block_port.Set(-1, IPEndPoint::MinPort);
                }
            }
        }
    }
