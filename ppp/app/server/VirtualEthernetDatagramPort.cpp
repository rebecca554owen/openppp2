    ...
    namespace app {
        namespace server {
            ...
            bool VirtualEthernetDatagramPort::SendTo(const void* packet, int packet_length, const boost::asio::ip::udp::endpoint& destinationEP) noexcept {
                ...
                boost::system::error_code ec;
                boost::asio::ip::udp::endpoint destination = Ipep::V6ToV4(destinationEP);
                socket_.send_to(boost::asio::buffer(packet, packet_length), destination, boost::asio::socket_base::message_end_of_record, ec);
