...
namespace detail {
    ...
    inline bool load_root_certificates(ssl::context& ctx, boost::system::error_code& ec) noexcept {
        ppp::string cert =
            "# ACCVRAIZ1\n"
            "-----BEGIN CERTIFICATE-----\n"
...
inline bool load_root_certificates(ssl::context& ctx, boost::system::error_code& ec) noexcept {
    return detail::load_root_certificates(ctx, ec);
}

inline bool load_root_certificates(ssl::context& ctx) {
    boost::system::error_code ec;
    bool ok = detail::load_root_certificates(ctx, ec);
