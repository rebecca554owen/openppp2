...
> **用途：**提供仓库总览，并将读者引导到当前有效的任务型文档。
> **适用对象：**OPENPPP2 用户、运维人员与开发者。
> **当前状态：**当前有效。
> **最后核对依据：**当前仓库结构与文档地图，2026-07-18。
> **文档索引：**[按任务浏览](docs/README_CN.md) · **English:** [English](README.md)
...
完整任务型目录见 [`docs/README_CN.md`](docs/README_CN.md)。
...
1. [`docs/ENGINEERING_CONCEPTS_CN.md`](docs/architecture/ENGINEERING_CONCEPTS_CN.md)
2. [`docs/ARCHITECTURE_CN.md`](docs/architecture/ARCHITECTURE_CN.md)
3. [`docs/STARTUP_AND_LIFECYCLE_CN.md`](docs/architecture/STARTUP_AND_LIFECYCLE_CN.md)
4. [`docs/TRANSMISSION_CN.md`](docs/architecture/TRANSMISSION_CN.md)
5. [`docs/HANDSHAKE_SEQUENCE_CN.md`](docs/architecture/HANDSHAKE_SEQUENCE_CN.md)
6. [`docs/PACKET_FORMATS_CN.md`](docs/reference/PACKET_FORMATS_CN.md)
7. [`docs/CLIENT_ARCHITECTURE_CN.md`](docs/architecture/CLIENT_ARCHITECTURE_CN.md)
8. [`docs/SERVER_ARCHITECTURE_CN.md`](docs/architecture/SERVER_ARCHITECTURE_CN.md)
9. [`docs/ROUTING_AND_DNS_CN.md`](docs/guides/ROUTING_AND_DNS_CN.md)
10. [`docs/PLATFORMS_CN.md`](docs/guides/PLATFORMS_CN.md)
11. [`docs/DEPLOYMENT_CN.md`](docs/operations/DEPLOYMENT_CN.md)
12. [`docs/OPERATIONS_CN.md`](docs/operations/OPERATIONS_CN.md)

### 想高效阅读源码

1. [`docs/SOURCE_READING_GUIDE_CN.md`](docs/development/SOURCE_READING_GUIDE_CN.md)
2. `main.cpp`
...
1. [`docs/CONFIGURATION_CN.md`](docs/reference/CONFIGURATION_CN.md)
2. [`docs/CLI_REFERENCE_CN.md`](docs/reference/CLI_REFERENCE_CN.md)
3. [`docs/PLATFORMS_CN.md`](docs/guides/PLATFORMS_CN.md)
4. [`docs/ROUTING_AND_DNS_CN.md`](docs/guides/ROUTING_AND_DNS_CN.md)
5. [`docs/DEPLOYMENT_CN.md`](docs/operations/DEPLOYMENT_CN.md)
6. [`docs/OPERATIONS_CN.md`](docs/operations/OPERATIONS_CN.md)
7. [`docs/SECURITY_CN.md`](docs/operations/SECURITY_CN.md)

### 深入研究（进阶）

1. [`docs/CONCURRENCY_MODEL_CN.md`](docs/architecture/CONCURRENCY_MODEL_CN.md)
2. [`docs/EDSM_STATE_MACHINES_CN.md`](docs/architecture/EDSM_STATE_MACHINES_CN.md)
3. [`docs/PACKET_LIFECYCLE_CN.md`](docs/architecture/PACKET_LIFECYCLE_CN.md)
4. [`docs/LINKLAYER_PROTOCOL_CN.md`](docs/reference/LINKLAYER_PROTOCOL_CN.md)
5. [`docs/TRANSMISSION_PACK_SESSIONID_CN.md`](docs/reference/TRANSMISSION_PACK_SESSIONID_CN.md)
6. [`docs/TUNNEL_DESIGN_CN.md`](docs/architecture/TUNNEL_DESIGN_CN.md)
7. [`docs/ERROR_CODES_CN.md`](docs/reference/ERROR_CODES_CN.md)
8. [`docs/ERROR_HANDLING_API_CN.md`](docs/reference/ERROR_HANDLING_API_CN.md)
9. [`docs/DIAGNOSTICS_ERROR_SYSTEM_CN.md`](docs/reference/DIAGNOSTICS_ERROR_SYSTEM_CN.md)

### IPv6 子系统

1. [`docs/IPV6_LEASE_MANAGEMENT_CN.md`](docs/guides/IPV6_LEASE_MANAGEMENT_CN.md)
2. [`docs/IPV6_TRANSIT_PLANE_CN.md`](docs/guides/IPV6_TRANSIT_PLANE_CN.md)
3. [`docs/IPV6_NDP_PROXY_CN.md`](docs/guides/IPV6_NDP_PROXY_CN.md)
4. [`docs/IPV6_CLIENT_ASSIGNMENT_CN.md`](docs/guides/IPV6_CLIENT_ASSIGNMENT_CN.md)
...
| 并发 | `ATOMIC_SHARED_PTR_HELPER_DESIGN.md` | `ATOMIC_SHARED_PTR_HELPER_DESIGN_CN.md` |
...
│   │   ├── ErrorCodes.def        # X-macro 源：628 个错误码
...
| `-DENABLE_IO_URING=ON` | 启用 io_uring 异步事件驱动（Linux 内核 ≥ 5.10） |
| `-DENABLE_SYSNAT=ON` | 启用 SYSNAT 内核旁路流量控制（仅 Linux） |
| `-DPPP_TELEMETRY=ON` | 启用可选的遥测/OTel 外观层 |
...
| 组 | 关键字段 | 说明 |
|----|---------|------|
| `key` | `kf`、`kx`、`kl`、`kh`、`sb`、`protocol`、`transport`、`masked`、`plaintext`、`delta-encode`、`shuffle-data` | 密码与混淆参数 |
| `server` | `node`、`subnet`、`mapping`、`backend`、`ipv4-pool`、`ipv6` | 服务端身份、IP 池与管理 |
| `client` | `server`、`bandwidth`、`reconnections`、`paper-airplane` | 客户端连接目标与 QoS |
| `tcp` | `listen.port`、`connect.timeout`、`inactive.timeout`、`turbo`、`fast-open` | TCP 套接字策略 |
| `websocket` | `host`、`path`、`listen.ws`、`listen.wss`、`ssl.*` | WebSocket 载体配置 |
| `concurrent` | （整数） | io_context 线程数 |
| `cdn` | （数组） | 混淆 CDN 端口模式 |

完整参考：[`docs/CONFIGURATION_CN.md`](docs/reference/CONFIGURATION_CN.md)
...
- **双密码层**：协议密码（头部元数据）和传输密码（载荷），均从 `base_key + ivv_str` 重建
...
完整 opcode 参考：[`docs/LINKLAYER_PROTOCOL_CN.md`](docs/reference/LINKLAYER_PROTOCOL_CN.md)
...
完整参考：[`docs/CLIENT_ARCHITECTURE_CN.md`](docs/architecture/CLIENT_ARCHITECTURE_CN.md)
...
完整参考：[`docs/SERVER_ARCHITECTURE_CN.md`](docs/architecture/SERVER_ARCHITECTURE_CN.md)
...
完整参考：[`docs/PLATFORMS_CN.md`](docs/guides/PLATFORMS_CN.md)
...
完整参考：[`docs/CONCURRENCY_MODEL_CN.md`](docs/architecture/CONCURRENCY_MODEL_CN.md)

---

## 错误处理概述

错误用类型化错误码表示，定义在 `ppp/diagnostics/ErrorCodes.def`（X-macro 宏展开）。当前共有 **628 个错误码**。
...
完整参考：[`docs/ERROR_CODES_CN.md`](docs/reference/ERROR_CODES_CN.md)、[`docs/ERROR_HANDLING_API_CN.md`](docs/reference/ERROR_HANDLING_API_CN.md)
...
完整参考：[`docs/MANAGEMENT_BACKEND_CN.md`](docs/guides/MANAGEMENT_BACKEND_CN.md)
...
| 层次 | 保护对象 | 密码来源 |
|------|---------|---------|
| 协议密码层 | 头部元数据与会话分帧 | `protocol-key + ivv_str` |
| 传输密码层 | 载荷数据 | `transport-key + ivv_str` |
...
完整参考：[`docs/SECURITY_CN.md`](docs/operations/SECURITY_CN.md)
...
完整参考：[`docs/IPV6_LEASE_MANAGEMENT_CN.md`](docs/guides/IPV6_LEASE_MANAGEMENT_CN.md)、[`docs/IPV6_TRANSIT_PLANE_CN.md`](docs/guides/IPV6_TRANSIT_PLANE_CN.md)、[`docs/IPV6_NDP_PROXY_CN.md`](docs/guides/IPV6_NDP_PROXY_CN.md)、[`docs/IPV6_CLIENT_ASSIGNMENT_CN.md`](docs/guides/IPV6_CLIENT_ASSIGNMENT_CN.md)
...
完整参考：[`docs/TUI_DESIGN_CN.md`](docs/architecture/TUI_DESIGN_CN.md)
...
完整参考：[`docs/PACKET_FORMATS_CN.md`](docs/reference/PACKET_FORMATS_CN.md)、[`docs/TUNNEL_DESIGN_CN.md`](docs/architecture/TUNNEL_DESIGN_CN.md)
...
完整参考：[`docs/LINKLAYER_PROTOCOL_CN.md`](docs/reference/LINKLAYER_PROTOCOL_CN.md)
...
完整参考：[`docs/PACKET_LIFECYCLE_CN.md`](docs/architecture/PACKET_LIFECYCLE_CN.md)
...
完整参考：[`docs/EDSM_STATE_MACHINES_CN.md`](docs/architecture/EDSM_STATE_MACHINES_CN.md)
...
完整参考：[`docs/TRANSMISSION_PACK_SESSIONID_CN.md`](docs/reference/TRANSMISSION_PACK_SESSIONID_CN.md)
...
完整参考：[`docs/DEPLOYMENT_CN.md`](docs/operations/DEPLOYMENT_CN.md)
...
完整参考：[`docs/OPERATIONS_CN.md`](docs/operations/OPERATIONS_CN.md)
...
完整参考：[`docs/DIAGNOSTICS_ERROR_SYSTEM_CN.md`](docs/reference/DIAGNOSTICS_ERROR_SYSTEM_CN.md)、[`docs/ERROR_CODES_CN.md`](docs/reference/ERROR_CODES_CN.md)
