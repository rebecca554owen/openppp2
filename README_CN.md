...
- 工程哲学：[`docs/ENGINEERING_PHILOSOPHY_CN.md`](docs/ENGINEERING_PHILOSOPHY_CN.md)
...
2. [`docs/ENGINEERING_PHILOSOPHY_CN.md`](docs/ENGINEERING_PHILOSOPHY_CN.md)
...
完整设计立场见 [`docs/ENGINEERING_PHILOSOPHY_CN.md`](docs/ENGINEERING_PHILOSOPHY_CN.md)。
