...
- [`ENGINEERING_CONCEPTS_CN.md`](ENGINEERING_CONCEPTS_CN.md)：为什么项目被设计成基础设施，而不是消费级 VPN 工具

### 产品级手册

- [`USER_MANUAL_CN.md`](USER_MANUAL_CN.md)：面向运维者的客户端与服务端运行手册
- [`CLI_REFERENCE_CN.md`](CLI_REFERENCE_CN.md)：按通用、角色专用、平台专用分类的命令行参考
