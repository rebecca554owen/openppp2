...
> **Parent index:** [Back to index](README.md) · **Chinese:** [运维与故障排查](OPERATIONS_CN.md)
...
- [`STARTUP_AND_LIFECYCLE.md`](../architecture/STARTUP_AND_LIFECYCLE.md)
- [`DEPLOYMENT.md`](DEPLOYMENT.md)
- [`PLATFORMS.md`](../guides/PLATFORMS.md)
- [`ERROR_HANDLING_API.md`](../reference/ERROR_HANDLING_API.md)
- [`DIAGNOSTICS_ERROR_SYSTEM.md`](../reference/DIAGNOSTICS_ERROR_SYSTEM.md)
