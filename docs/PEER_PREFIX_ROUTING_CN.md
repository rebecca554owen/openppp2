...
- [`SERVER_IPV4_ASSIGNMENT_CN.md`](SERVER_IPV4_ASSIGNMENT_CN.md) — 虚拟 IP 自动/手动分配
- [`P2P_NETWORKING_PLAN.md`](P2P_NETWORKING_PLAN.md) — P2P 直连（与前缀路由正交）
- [`CONFIGURATION_CN.md`](CONFIGURATION_CN.md) — 全局配置索引
