...
> **Parent index:** [Back to index](../README.md) · **Chinese:** [开发文档](README_CN.md)


This section groups current documentation by user task and maintenance responsibility.

- [Code style and module boundaries](../governance/CODE_STYLE.md)
- [Documentation style](../governance/DOCUMENTATION_STYLE.md)

- [Boost 1.87+ 兼容性分析报告](BOOST_187_COMPATIBILITY.md)
- [Source Reading Guide](SOURCE_READING_GUIDE.md)
- [Testing](TESTING.md)
