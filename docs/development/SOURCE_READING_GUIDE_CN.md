...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Source Reading Guide](SOURCE_READING_GUIDE.md)
...
- [`ARCHITECTURE_CN.md`](../architecture/ARCHITECTURE_CN.md)
- [`TUNNEL_DESIGN_CN.md`](../architecture/TUNNEL_DESIGN_CN.md)
...
- [`EDSM_STATE_MACHINES_CN.md`](../architecture/EDSM_STATE_MACHINES_CN.md)
- [`LINKLAYER_PROTOCOL_CN.md`](../reference/LINKLAYER_PROTOCOL_CN.md)
- [`HANDSHAKE_SEQUENCE_CN.md`](../architecture/HANDSHAKE_SEQUENCE_CN.md)
