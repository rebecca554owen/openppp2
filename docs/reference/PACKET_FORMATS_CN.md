...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Packet Formats And On-Wire Layout Interpretation](PACKET_FORMATS.md)
...
- [`HANDSHAKE_SEQUENCE_CN.md`](../architecture/HANDSHAKE_SEQUENCE_CN.md) — 握手与密码生命周期
- [`TRANSMISSION_PACK_SESSIONID_CN.md`](TRANSMISSION_PACK_SESSIONID_CN.md) — session-id 包打解包
- [`TRANSMISSION_CN.md`](../architecture/TRANSMISSION_CN.md) — 传输层架构
- [`SECURITY_CN.md`](../operations/SECURITY_CN.md) — 安全模型
