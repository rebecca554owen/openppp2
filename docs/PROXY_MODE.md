...
See [CLI_REFERENCE.md](CLI_REFERENCE.md) and [CONFIGURATION.md](CONFIGURATION.md) for full details.

## Related docs

- [PROXY_ONLY_MODE_PLAN.md](PROXY_ONLY_MODE_PLAN.md) — implementation and test plan
- [PROXY_MODE_TEST_PLAN.md](PROXY_MODE_TEST_PLAN.md) — test matrix
- [TESTING.md](TESTING.md) — unit tests and coverage
