...
> **Parent index:** [Back to index](README.md) · **Chinese:** [启动、进程所有权与生命周期控制](STARTUP_AND_LIFECYCLE_CN.md)
...
- [`SOURCE_READING_GUIDE.md`](../development/SOURCE_READING_GUIDE.md) — Where to start reading the code
- [`ERROR_HANDLING_API.md`](../reference/ERROR_HANDLING_API.md) — Error code API reference
- [`CONFIGURATION.md`](../reference/CONFIGURATION.md) — AppConfiguration fields and Loaded() behavior
- [`CONCURRENCY_MODEL.md`](CONCURRENCY_MODEL.md) — Thread pool, io_context, and coroutine model
- [`PLATFORMS.md`](../guides/PLATFORMS.md) — Platform-specific startup differences
