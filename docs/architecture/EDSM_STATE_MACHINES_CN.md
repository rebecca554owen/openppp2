...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[EDSM State Machines](EDSM_STATE_MACHINES.md)
...
- [`LINKLAYER_PROTOCOL_CN.md`](../reference/LINKLAYER_PROTOCOL_CN.md) — 链路层操作码 wire 格式
- [`HANDSHAKE_SEQUENCE_CN.md`](HANDSHAKE_SEQUENCE_CN.md) — 握手时序详解
- [`SOURCE_READING_GUIDE_CN.md`](../development/SOURCE_READING_GUIDE_CN.md) — 代码阅读指南
