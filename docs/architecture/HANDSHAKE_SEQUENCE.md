...
> **Parent index:** [Back to index](README.md) · **Chinese:** [握手序列与会话建立](HANDSHAKE_SEQUENCE_CN.md)
...
- [`TRANSMISSION_PACK_SESSIONID.md`](../reference/TRANSMISSION_PACK_SESSIONID.md) — Detailed session-id pack/unpack analysis
- [`PACKET_FORMATS.md`](../reference/PACKET_FORMATS.md) — Wire format of base94 and binary frames
- [`SECURITY.md`](../operations/SECURITY.md) — Security model and honest threat analysis
