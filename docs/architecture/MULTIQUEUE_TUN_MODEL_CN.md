...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[OpenPPP2 Linux Single Virtual NIC Multi-Queue Model Design](MULTIQUEUE_TUN_MODEL.md)


[English Version](MULTIQUEUE_TUN_MODEL.md)
