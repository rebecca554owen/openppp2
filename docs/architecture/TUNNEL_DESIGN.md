...
> **Parent index:** [Back to index](README.md) · **Chinese:** [隧道设计详解](TUNNEL_DESIGN_CN.md)
...
- [`PACKET_FORMATS.md`](../reference/PACKET_FORMATS.md) — Wire format specifications for all frame types
- [`HANDSHAKE_SEQUENCE.md`](HANDSHAKE_SEQUENCE.md) — Step-by-step handshake sequence
- [`LINKLAYER_PROTOCOL.md`](../reference/LINKLAYER_PROTOCOL.md) — Full opcode vocabulary reference
- [`TRANSMISSION_PACK_SESSIONID.md`](../reference/TRANSMISSION_PACK_SESSIONID.md) — Session identity and control plane
- [`PACKET_LIFECYCLE.md`](PACKET_LIFECYCLE.md) — Complete packet journey from TAP to remote
- [`SECURITY.md`](../operations/SECURITY.md) — Security model and threat analysis
