...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Handshake Sequence And Session Establishment](HANDSHAKE_SEQUENCE.md)
...
- [`TRANSMISSION_PACK_SESSIONID_CN.md`](../reference/TRANSMISSION_PACK_SESSIONID_CN.md) — session-id 包打解包详细分析
- [`PACKET_FORMATS_CN.md`](../reference/PACKET_FORMATS_CN.md) — base94 和二进制包的线上格式
- [`SECURITY_CN.md`](../operations/SECURITY_CN.md) — 安全模型概述
