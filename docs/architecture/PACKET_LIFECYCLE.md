...
> **Parent index:** [Back to index](README.md) · **Chinese:** [数据包完整生命周期 — 从 TAP 到远端再回来](PACKET_LIFECYCLE_CN.md)
...
|----------|-------------|
| [`PACKET_FORMATS.md`](../reference/PACKET_FORMATS.md) | Wire format and obfuscation transforms for transmission frames |
| [`LINKLAYER_PROTOCOL.md`](../reference/LINKLAYER_PROTOCOL.md) | Link-layer opcode protocol overview |
