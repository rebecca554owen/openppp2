...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Packet Complete Lifecycle — From TAP to Remote and Back](PACKET_LIFECYCLE.md)
...
| 文档 | 描述 |
|------|------|
| [`PACKET_FORMATS.md`](../reference/PACKET_FORMATS.md) | 传输帧的线缆格式与混淆变换 |
| [`LINKLAYER_PROTOCOL.md`](../reference/LINKLAYER_PROTOCOL.md) | 链路层操作码协议概述 |
