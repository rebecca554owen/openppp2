...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Transport, Framing, And Protected Tunnel Model](TRANSMISSION.md)
...
- [`PACKET_FORMATS_CN.md`](../reference/PACKET_FORMATS_CN.md) — 帧格式字节级说明
- [`TRANSMISSION_PACK_SESSIONID_CN.md`](../reference/TRANSMISSION_PACK_SESSIONID_CN.md) — session_id 打包方法
- [`TUNNEL_DESIGN_CN.md`](TUNNEL_DESIGN_CN.md) — 隧道分层架构总览
- [`SECURITY_CN.md`](../operations/SECURITY_CN.md) — 安全模型与威胁分析
- [`CONFIGURATION_CN.md`](../reference/CONFIGURATION_CN.md) — key 块配置说明
