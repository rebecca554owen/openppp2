...
> **上一层索引：**[返回索引](README_CN.md) · **English：**[Startup, Process Ownership, and Lifecycle Control](STARTUP_AND_LIFECYCLE.md)
...
- [`SOURCE_READING_GUIDE_CN.md`](../development/SOURCE_READING_GUIDE_CN.md) — 代码阅读指引
- [`ERROR_HANDLING_API_CN.md`](../reference/ERROR_HANDLING_API_CN.md) — 错误处理 API 参考
- [`CONCURRENCY_MODEL_CN.md`](CONCURRENCY_MODEL_CN.md) — 并发模型与线程池
- [`CONFIGURATION_CN.md`](../reference/CONFIGURATION_CN.md) — 配置结构与 Loaded() 策略编译
