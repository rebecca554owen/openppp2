...
> **Parent index:** [Back to index](README.md) · **Chinese:** [传输、帧化与受保护隧道模型](TRANSMISSION_CN.md)
...
- [`PACKET_FORMATS.md`](../reference/PACKET_FORMATS.md) — Wire format for all packet types
- [`TRANSMISSION_PACK_SESSIONID.md`](../reference/TRANSMISSION_PACK_SESSIONID.md) — Session ID packaging details
- [`CONFIGURATION.md`](../reference/CONFIGURATION.md) — Full `appsettings.json` schema including transport config
